        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumPasaporte = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pasajeros_Paises_PaisId",
                        column: x => x.PaisId,
                        principalTable: "Paises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vuelos_Asientos_AsientoId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vuelos_Reservas_ReservaId",
                        column: x => x.ReservaId,
                        principalTable: "Reservas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vuelos_Tarifas_TarifaId",
                        column: x => x.TarifaId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumComprobante = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pagos_Pasajeros_PasajeroId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pasajeros_PaisId",
                table: "Pasajeros",
                column: "PaisId");

            migrationBuilder.CreateIndex(
                name: "IX_Vuelos_AsientoId",
                table: "Vuelos",
                column: "AsientoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vuelos_ReservaId",
                table: "Vuelos",
                column: "ReservaId");

            migrationBuilder.CreateIndex(
                name: "IX_Vuelos_TarifaId",
                table: "Vuelos",
                column: "TarifaId");
        }
